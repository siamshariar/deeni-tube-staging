...
import { ArrowLeft, Gamepad2, MoreVertical, Play, ChevronLeft, ChevronRight } from "lucide-react"
...
const gamingVideos = [
  { id: "g1", title: "Islamic Quiz Game - Test Your Knowledge", channel: "Islamic Games", channelAvatar: "/placeholder.svg?height=36&width=36", views: "320K views", timeAgo: "2 weeks ago", duration: "25:15", thumbnail: "/placeholder.svg?height=480&width=854" },
  { id: "g2", title: "Quran Competition 2024 - Finals", channel: "Deen Challenge", channelAvatar: "/placeholder.svg?height=36&width=36", views: "180K views", timeAgo: "1 month ago", duration: "45:30", thumbnail: "/placeholder.svg?height=480&width=854" },
  { id: "g3", title: "Islamic Trivia - Prophets Edition", channel: "Quiz Islam", channelAvatar: "/placeholder.svg?height=36&width=36", views: "95K views", timeAgo: "2 months ago", duration: "15:40", thumbnail: "/placeholder.svg?height=480&width=854" },
  { id: "g4", title: "Halal Games Review - Top 5 Picks", channel: "Muslim Gaming", channelAvatar: "/placeholder.svg?height=36&width=36", views: "210K views", timeAgo: "3 months ago", duration: "18:20", thumbnail: "/placeholder.svg?height=480&width=854" },
  { id: "g5", title: "Islamic Geography Challenge", channel: "Islamic Games", channelAvatar: "/placeholder.svg?height=36&width=36", views: "75K views", timeAgo: "4 months ago", duration: "12:50", thumbnail: "/placeholder.svg?height=480&width=854" },
  { id: "g6", title: "Learn Arabic Through Games", channel: "Arabic Fun", channelAvatar: "/placeholder.svg?height=36&width=36", views: "150K views", timeAgo: "5 months ago", duration: "22:10", thumbnail: "/placeholder.svg?height=480&width=854" },
  { id: "g7", title: "Islamic Board Game Night", channel: "Muslim Gaming", channelAvatar: "/placeholder.svg?height=36&width=36", views: "65K views", timeAgo: "6 months ago", duration: "28:15", thumbnail: "/placeholder.svg?height=480&width=854" },
  { id: "g8", title: "Prophet Stories Interactive Quiz", channel: "Islamic Games", channelAvatar: "/placeholder.svg?height=36&width=36", views: "120K views", timeAgo: "7 months ago", duration: "35:00", thumbnail: "/placeholder.svg?height=480&width=854" },
]

const gameCategories = ["All", "Quiz", "Competition", "Trivia", "Reviews", "Educational", "Board Games"]
        ...
        <div className="flex-1 md:pl-[240px] pt-[56px] md:pt-[80px] pb-nav-safe md:pb-6">
          <div className="md:hidden flex items-center gap-2 px-3 py-2.5 border-b sticky top-[56px] bg-background z-20">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <h1 className="font-semibold text-base">Gaming</h1>
            </div>
          </div>
          ...
          <div className="max-w-[1096px] mx-auto px-3 md:px-6">
            <div className="hidden md:flex items-center gap-3 py-4 md:py-6">
              ...
              <div>
                <h1 className="text-2xl font-bold">Islamic Games & Quizzes</h1>
                <p className="text-sm text-muted-foreground">Fun and educational Islamic games</p>
              </div>
            </div>
            ...
            {!isLoading && <p className="text-xs md:text-sm text-muted-foreground mb-3 md:mb-4">{gamingVideos.length} videos</p>}
