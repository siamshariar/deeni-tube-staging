      ...
      <div className="px-4 md:px-6 py-6 md:py-8 mt-16 max-w-3xl mx-auto">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">How we handle your data and keep you safe</p>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <section>
            <h2 className="text-lg font-semibold mb-3 flex items-center gap-2">
              <Database className="h-5 w-5 text-primary" /> Data We Collect
            </h2>
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 flex items-center gap-2">
              <Eye className="h-5 w-5 text-primary" /> Content Visibility
            </h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3 flex items-center gap-2">
              <UserCheck className="h-5 w-5 text-primary" /> Your Rights
            </h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
