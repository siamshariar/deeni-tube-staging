          ...
          <div className="flex items-center gap-2 px-3 py-2 w-full">
            ...
            >
              ...
              <Button
                variant="ghost"
                size="icon"
                className="rounded-full flex-shrink-0 bg-muted hover:bg-muted/80"
                type="button"
              >
          ...
          <div className="flex-1 max-w-[720px] mx-4 min-w-0">
            <form onSubmit={(e) => e.preventDefault()} className="flex items-center">
              ...
              <Button
                variant="ghost"
                size="icon"
                className="rounded-full ml-2 bg-muted hover:bg-muted/80 flex-shrink-0"
              >
            ...
            <div className="min-w-[90px] flex items-center justify-end">
              {!authLoaded ? (
                ...
                <Link href="/signin">
                  <Button
                    variant="outline"
                    className="rounded-full flex items-center gap-2 h-9 text-sm px-4 text-primary border-primary/50 hover:bg-primary/10"
                  >
                    <UserCircle className="h-5 w-5" />
                    <span>Sign In</span>
                  </Button>
